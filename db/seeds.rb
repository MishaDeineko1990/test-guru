...
test_2 = Test.create!(name: 'Rails console', level: 1, time_limit: 60, category_id: category_1.id, user_id: user_1.id)
test_3 = Test.create!(name: 'Rails ActiveRecord', level: 2, time_limit: 60, category_id: category_1.id, user_id: user_1.id)
